    ...
    <div class="main-container">
        ...
        <div class="main">
            ...
            <div class="report-container">
                ...
                @if(Session('status'))
                <h4 class="bg bg-primary text-white center">{{Session('status')}}</h4>
            @endif
                <div class="container">
                    <div class="row">
                           ...
                           <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <td>{{$data['task']}}</td>
                                <td>{{$data['status']}}</td>
                                <td><a href="{{'edit/'.$data['id']}}" class="btn btn-primary">EDIT</a>
                                <a href="{{'delete/'.$data['id']}}" class="btn btn-danger ">DELETE</a>
                                <a href="{{'task/'.$data['id']}}" class="btn btn-success">TASK</a></td>
                            </tr>
                            @endforeach
            </tbody>
            </div>
